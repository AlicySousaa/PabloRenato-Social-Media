# Pablo Renato - Social Media Portfolio
...
├── src/
│   ├── img/               # Imagens (logos e resultados)
...
```bash
git clone https://github.com/AlicySousaa/PabloRenato-Social-Media.git
```

2. Entre na pasta do projeto:
```bash
cd PabloRenato-Social-Media
```
...
4. Compile o Tailwind CSS (modo watch):
```bash
npm run dev
```
